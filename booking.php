...
if(isset($_POST['submit'])){
	...
	$todate=$_POST['todate'];
	$tourguidecharges=$_POST['tourguide'];
	$vid=$_POST['vid'];
//cek
...
if(mysqli_num_rows($query)>0){
		...
		echo "<script type='text/javascript'> document.location = 'booking_ready.php?vid=$vid&mulai=$fromdate&selesai=$todate&tourguide=$tourguidecharges'; </script>";
	}
}
?>
<!DOCTYPE HTML>
