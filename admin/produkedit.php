							...
							<div class="col-md-12">
								<div class="panel panel-default">
									...
									<div class="panel-body">
										...
										<div class="form-group">
											...
											<div class="col-sm-3">
												...
												{?>
													<div class="checkbox checkbox-inline">
														<input type="checkbox" id="inlineCheckbox2" name="Senter" checked value="1">
														<label for="inlineCheckbox2"> Senter </label>
													</div>
												<?php } else {?>
													<div class="checkbox checkbox-success checkbox-inline">
														<input type="checkbox" id="inlineCheckbox2" name="Senter" value="1">
														<label for="inlineCheckbox2"> Senter </label>
													</div>
												<?php }?>
											</div>
											...
											{?>
												<div class="checkbox checkbox-inline">
													<input type="checkbox" id="inlineCheckbox3" name="Bantal" checked value="1">
													<label for="inlineCheckbox3"> Bantal </label>
												</div>
											<?php } else {?>
												<div class="checkbox checkbox-inline">
													<input type="checkbox" id="inlineCheckbox3" name="Bantal" value="1">
													<label for="inlineCheckbox3"> Bantal </label>
												</div>
											<?php } ?>
											</div>
											...
											{?>
												<div class="checkbox checkbox-inline">
													<input type="checkbox" id="inlineCheckbox4" name="PisauLipat" checked value="1">
													<label for="inlineCheckbox3"> Pisau Lipat </label>
												</div>
											<?php } else {?>
												<div class="checkbox checkbox-inline">
													<input type="checkbox" id="inlineCheckbox4" name="PisauLipat" value="1">
													<label  for="inlineCheckbox3"> Pisau Lipat </label>
												</div>
											<?php } ?>
											</div>
									...
									<div class="form-group">
										...
										{?>
											<div class="checkbox checkbox-inline">
												<input type="checkbox" id="inlineCheckbox5" name="EmergencyLamp" checked value="1">
												<label for="inlineCheckbox1"> Emergency Lamp </label>
											</div>
										<?php } else {?>
											<div class="checkbox checkbox-inline">
												<input type="checkbox" id="inlineCheckbox5" name="EmergencyLamp" value="1">
												<label for="inlineCheckbox1"> Emergency Lamp </label>
											</div>
										<?php } ?>
										</div>
										...
										{?>
											<div class="checkbox checkbox-inline">
												<input type="checkbox" id="inlineCheckbox6" name="MejaLipat" checked value="1">
												<label for="inlineCheckbox2">Meja Lipat</label>
											</div>
										<?php } else { ?>
											<div class="checkbox checkbox-inline">
												<input type="checkbox" id="inlineCheckbox6" name="MejaLipat" value="1">
												<label for="inlineCheckbox2">Meja Lipat</label>
											</div>
										<?php } ?>
										</div>
										...
										{?>
											<div class="checkbox checkbox-inline">
												<input type="checkbox" id="inlineCheckbox7" name="KursiLipat" checked value="1">
												<label for="inlineCheckbox3"> Kursi Lipat </label>
											</div>
										<?php } else { ?>
											<div class="checkbox checkbox-inline">
												<input type="checkbox" id="inlineCheckbox7" name="KursiLipat" value="1">
												<label for="inlineCheckbox3"> Kursi Lipat </label>
											</div>
										<?php } ?>
										</div>
										...
										<?php if($result['Matras']==1) { ?>
											<div class="checkbox checkbox-inline">
												<input type="checkbox" id="inlineCheckbox7" name="Matras" checked value="1">
												<label for="inlineCheckbox7"> Matras </label>
											</div>
										<?php } else { ?>
											<div class="checkbox checkbox-inline">
												<input type="checkbox" id="inlineCheckbox7" name="Matras" value="1">
												<label for="inlineCheckbox7"> Matras </label>
											</div>
										<?php } ?>
										</div>
									...
									<div class="form-group">
										...
										{?>
											<div class="checkbox checkbox-inline">
												<input type="checkbox" id="inlineCheckbox9" name="Ponco" checked value="1">
												<label for="inlineCheckbox1"> Ponco </label>
											</div>
										<?php } else {?>
											<div class="checkbox checkbox-inline">
												<input type="checkbox" id="inlineCheckbox9" name="Ponco" value="1">
												<label for="inlineCheckbox1"> Ponco </label>
											</div>
										<?php } ?>
										</div>
										...
										{?>
											<div class="checkbox  checkbox-inline">
												<input type="checkbox" id="inlineCheckbox10" name="Pluit" checked value="1">
												<label for="inlineCheckbox2">Pluit</label>
											</div>
										<?php } else { ?>
											<div class="checkbox checkbox-success checkbox-inline">
												<input type="checkbox" id="inlineCheckbox10" name="Pluit" value="1">
												<label for="inlineCheckbox2">Pluit</label>
											</div>
										<?php } ?>
										</div>
										...
										{?>
											<div class="checkbox checkbox-inline">
												<input type="checkbox" id="inlineCheckbox11" name="PeralatanSanitasi" checked value="1">
												<label for="inlineCheckbox3"> Peralatan Sanitasi </label>
											</div>
										<?php } else {?>
											<div class="checkbox checkbox-inline">
												<input type="checkbox" id="inlineCheckbox11" name="PeralatanSanitasi" value="1">
												<label for="inlineCheckbox3"> Peralatan Sanitasi </label>
											</div>
										<?php } ?>
										</div>
										...
										{?>
											<div class="checkbox checkbox-inline">
												<input type="checkbox" id="inlineCheckbox12" name="Binocular" checked value="1">
												<label for="inlineCheckbox3"> Binocular </label>
											</div>
										<?php } else { ?>
											<div class="checkbox checkbox-inline">
												<input type="checkbox" id="inlineCheckbox12" name="Binocular" value="1">
												<label for="inlineCheckbox3"> Binocular </label>
											</div>
										<?php } ?>
										</div>
